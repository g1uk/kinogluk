...
public class CompanyController {
    ...
    @PostMapping(value = "/company/{companyId}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostMapping(value = "/company/delete/{companyId}", produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void deleteById (@PathVariable("companyId") int id) {
        companyService.deleteById(id);
    }

    @PostMapping(value = "/company/delete", produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseStatus(HttpStatus.NO_CONTENT)
